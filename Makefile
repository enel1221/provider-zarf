...
xpkg.build.provider-zarf: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Zarf CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Zarf controllers
...
# This target prepares repo for your provider by replacing all "zarf"
